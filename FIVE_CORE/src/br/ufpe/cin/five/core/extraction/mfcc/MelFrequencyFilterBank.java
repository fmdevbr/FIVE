...
public class MelFrequencyFilterBank {
  // ----------------------------------
    ...
    public MelFrequencyFilterBank(int numberFilters,double minFreq,double maxFreq, double sampleRate){
    ...
    public double[] process(double[] in) {
        int numberFftPoints = in.length;
        double [] retorno = new double[numberFilters];
